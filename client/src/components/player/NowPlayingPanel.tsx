...
export default function NowPlayingPanel() {
  ...
  return (
    <>
      ...
      <aside className="w-[280px] flex-shrink-0 bg-sp-card rounded-lg flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 flex-shrink-0">
          <span className="text-sm font-semibold text-sp-text">Now Playing</span>
          <button
        ...
        {/* Cover art — clickable to go fullscreen */}
